...
from src.adapters.amazon_product_collector import AmazonProductCollectorFromSavedFile
...
from src.adapters.amazon_reports_collector import AmazonSavedReportCollector
